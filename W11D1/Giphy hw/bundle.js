...
var fetchSearchGiphys = function fetchSearchGiphys(search) {
  return function (dispatch) {
    return _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](search).then(function (giphs) {
      return dispatch(receiveSearchGiphys(giphs.data));
    });
  };
};
var receiveSearchGiphys = function receiveSearchGiphys(giphs) {
  return {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(search) {
      return dispatch(Object(_actions_giphy_actions__WEBPACK_IMPORTED_MODULE_2__["fetchSearchGiphys"])(search));
    }
  };
};
...
var fetchSearchGiphys = function fetchSearchGiphys(search) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(search, "&api_key=dc6zaTOxFJmzC&limit=2")
  });
};
